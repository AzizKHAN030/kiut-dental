...
export const popularTreatmentsSection = defineType({
  ...
  fields: [
    defineField({
      ...
      type: 'string',
      description: 'Text to display in the navigation menu (e.g., "Services"). Leave empty to hide from menu.',
    }),
    defineField({
      name: 'navLinkId',
      title: 'Navigation Link ID',
      type: 'string',
      description: 'Anchor ID for navigation (e.g., "services"). Should match the section ID on the page.',
