...
export const heroSlideBackground = defineType({
  name: 'heroSlideBackground',
  title: 'Hero slide – background image',
  type: 'object',
  fields: [
    defineField({
      name: 'tagline',
    ...
    defineField({
      ...
      description: 'Position of the text content block on the screen.',
    }),
    defineField({
