...
export const testimonialsSection = defineType({
  ...
  fields: [
    defineField({
      ...
      type: 'string',
      description: 'Text to display in the navigation menu (e.g., "Testimonials"). Leave empty to hide from menu.',
    }),
    defineField({
      name: 'navLinkId',
      title: 'Navigation Link ID',
      type: 'string',
      description: 'Anchor ID for navigation (e.g., "testimonials"). Should match the section ID on the page.',
